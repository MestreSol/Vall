    ...
    <div class="container">
        ...
        <form id="cadastroForm"  method="POST" >
            ...
            <div class="form-group">
                ...
                <?php
                    $url = 'http://127.0.0.1:5000/instituicoes';
                    $data = file_get_contents($url);
                    $instituicoes = json_decode($data, true);

                    if ($instituicoes === null && json_last_error() !== JSON_ERROR_NONE) {
                        echo "Erro na leitura do JSON: " . json_last_error_msg();
                    } else {
